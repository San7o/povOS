  ...
  ;; 0x06401 - 0x07BFF   6 KB     stack
  ;; 0x06000 - 0x06400   1 KB     Memory Map
  ;; 0x01000 - 0x05FFF   20 KB    Page Tables
  ...
  %define $PDT_ADDR           $PDPT_ADDR  + 0x1000
  %define $PT1_ADDR           $PDT_ADDR   + 0x1000
  %define $PT2_ADDR           $PT1_ADDR   + 0x1000
  
  %define $MMAP_ADDR          0x6000
